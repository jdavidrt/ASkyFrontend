    ...
    return (
        <React.Fragment>
            <div className="mt-2 justify-center relative flex content-center pt-[100px]">
                <h1
                    className="text-[300px] font-extrabold absolute top-0 text-[#263B44] drop-shadow-7xl max-w-[1200px] w-[100%] overflow-x-hidden"
            ...
            <div className="z-20 relative">
                <div className="justify-center flex content-center">
                    <p className="text-[#48AFDE] font-bold text-5xl md:text-7xl">Contactanos</p>
                </div>
                    ...
                    <form>
                        <div className="grid lg:gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label
                                    htmlFor="first_name"
                                    className="block mb-2 text-sm font-medium text-[#47626D]"
                                >
                                    Nombre
                                </label>
                                <input
                                    ...
                                    className="bg-[#EEF7FB] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5"
                        ...
                        <div className="mb-6">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                id="text"
                                className="bg-[#EEF7FB] text-gray-900 h-[250px] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5"
                        ...
                        <button
                            ...
                            disabled={loader}
                            className="text-white font-[700] bg-[#48AFDE] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-lg w-full sm:w-auto px-9 p-3.5 text-center"
                        >
                            {loader ? (
                                <div role="status">
                                    <svg
            ...
            >
                ...
                <div className="bg-white rounded-lg font-sans p-4 z-50 w-[400px]">
                    ...
                    <p className="mb-4">Please fill the form carefully. A field is empty!</p>
                    <button
            ...
            {/* Implementing the modal pop if message is sent successfully */}
            <div
                className={`fixed inset-0 flex items-center justify-center z-20 ${
